            ...
            <div class="flex flex-col lg:flex-row text-sm">
                ...
                <div class="w-full lg:w-1/4 lg:p-4 lg:border-r">
                  <ul class="space-y-4">
                    ...
                    <RouterLink v-if="isEmployerOrAdmin" to="/jobs-dashboard" class="flex items-center px-4 py-2 border rounded-lg border-main text-main hover-up">
                      <span  class="text-main"> <i class="fas fa-briefcase mr-4 text-gray-400"></i>Jobs Dashboard</span>
                    </RouterLink>
                ...
                <div class="w-full lg:w-3/4 lg:px-8 mt-5 lg:mt-0">
                  ...
                  <table class="min-w-full border">
                    <thead class="bg-gray-100">
                      <tr>
                        <th class="py-2 px-4 text-left font-semibold">Image</th>
